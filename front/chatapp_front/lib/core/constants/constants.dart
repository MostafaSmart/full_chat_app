...
final namedValidator = MultiValidator([
  ...
  MinLengthValidator(10, errorText: 'Must input full name'),

]);

final phoneValidator = MultiValidator([
  RequiredValidator(errorText: 'phone is required'),
  MinLengthValidator(9, errorText: 'Number must be 9 digits long'),
  MaxLengthValidator(10, errorText: 'Numberss must be 9 digits long')
